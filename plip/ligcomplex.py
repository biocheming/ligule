...
def create_lig_complex(pdb_path, lig_code):
    """ Receives a path to a pdb file and a PLIP recognizeable ligand
    code (truncated to 3 letters), and returns a PDBComplex object
    """
    
    # create the PDBComplex object
    pdb = PDBComplex()
    # load the pdb
    ...
    for ligand in pdb.ligands:
        if ligand.longname == lig_code:
            pdb.characterize_complex(ligand)
