...
@click.option('--weights', default=None, type=click.Path(exists=True), help="")
...
def contact_freqs(output, cutoff, nframes, hetatoms, plot, weights, ligand, topology, traj_paths):
    import mdtraj as md
    import numpy as np
    import pandas as pd
...
ligandmap.add_command(contact_freqs)
